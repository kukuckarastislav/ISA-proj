<template>
    ...
    <div class="container">
        <div class="row">
            ...
            <div v-if="adventure.name != undefined" class="col-sm-6">
                ...
                <h1 class="text-start">{{adventure.name}} <button v-if="role==='ROLE_CUSTOMER' && !isSubscribed" style="float:right" type="button" class="btn btn-primary" v-on:click="subscribeToActions()">Subscribe to actions</button></h1> <br>
            ...
            <div class="card">
              <div class="card-body">
                  <div style="height: 300px;" class="row">
                      <div class="col-sm-9">
                          <div style="background-color: gray; height:100%;position: relative; top:-0.8em;" id = "map" > Adventure location</div>
                      </div>
    ...
    <tbody>
                ...
                <div class="row">
                    <div class="d-md-flex align-items-center justify-content-center">
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <label class="btn btn-outline-primary" for="btnradio1">ADVENTURE REVISIONS</label>

                            <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" v-on:click="button2Clicked">
                            <label class="btn btn-outline-primary" for="btnradio2">INSTRUCTOR REVISIONS</label>
      ...
      <div v-if="button1">
      <table v-for="a in adventure.revisions"
  ...
  <div v-else>
      <table v-for="a in instructor.revisions"
            :key="a.id" style=" width: 50%; margin-left:25%; margin-top: 5%;text-align:left" class="table border border-primary">
    <tbody v-if="a.statusOfRevision=='APPROVED'">
      <tr>
        <td style="border:none;zoom:0.5"><star-rating style="margin-left:7em" v-model:rating="a.grade" v-bind:show-rating=false v-bind:read-only=true /></td>
...
export default {
  ...
  components: {CarouselView,ReserveModal,StarRating},
  data: function () {
    return {
      adventure: {},
      instructor: null,
            ...
            zoom: 7
              ...
              if (this.role === 'ROLE_CUSTOMER') {
                ...
                "Bearer " + window.sessionStorage.getItem("jwt");
                  axios
          .post('http://localhost:8180/api/client/isSubscribed',{type:"adventure", id:this.adventureId})
          .then(response => {
