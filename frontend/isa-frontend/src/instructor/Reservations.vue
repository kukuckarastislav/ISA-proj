            ...
            <div class="col-sm-3">
                <div class="card align-items-start">
                    <div class="card-body justify-content-start text-start">
                        ...
                        <input v-model="filter.adventureName" type="text" class="form-control" />
...
export default {
  ...
  methods: {
    ...
    showIf: function(reservation){
        return this.showByAdventureName(reservation) && this.showByReservationType(reservation) && this.showByClientName(reservation) && this.showByTime(reservation)
    },
    showByAdventureName: function(reservation){
