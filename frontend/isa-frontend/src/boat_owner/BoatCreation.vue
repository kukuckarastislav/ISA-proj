    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <textarea class="form-control" v-model="boat.description" rows="3"></textarea>
                <br>
                ...
                <div v-if="boat.additionalEquipments.length > 0" class="card">
                  <div class="card-body">
                      <span v-for="addEq in boat.additionalEquipments" :key="addEq" class="badge bg-primary m-1">{{addEq.name}}</span> 
                  </div>
                </div>
        ...
        <br> <br>
        <button v-on:click="createNewBoat()" class="btn btn-primary m-5 p-3">Create new boat</button>
...
this.map = new Map({
  ...
  methods: {
    ...
    clickAdditionalEq: function(additionalEq){
        for (var i = 0; i < this.boat.additionalEquipments.length; i++) {
            if(this.boat.additionalEquipments[i].id == additionalEq.id){
                //remove
                this.boat.additionalEquipments.splice(i, 1);
        ...
        //add
        this.boat.additionalEquipments.push(additionalEq);
    ...
    clickItemPrice: function(itemPrice){
        for (var i = 0; i < this.boat.pricelist.length; i++) {
            if(this.boat.pricelist[i].id == itemPrice.id){
                //remove
                this.boat.pricelist.splice(i, 1);
                console.log("removed element from itemPrice with id="+itemPrice.id);
                return;
            }
        }
        //add
        this.boat.pricelist.push(itemPrice);
