            ...
            <div class="col-sm-3">
                <div class="card align-items-start">
                    <div class="card-body justify-content-start text-start">
                        ...
                        <hr>
                        <h5>Cottage Name</h5>
                        <input v-model="filter.cottageName" type="text" class="form-control" />
            ...
            <div class="col-sm-9">
                <div v-for="reservation in reservations" :key="reservation">
                        ...
                        <div v-if="showIf(reservation)">
                            <CottageReservationViewComponent v-bind:reservation="reservation" />
                            <br> <br>
                        </div>
...
import CottageReservationViewComponent from '../cottage_owner/CottageReservationViewComponent.vue'
export default {
  ...
  methods: {
    loadData: function(){
        ...
        axios.get('http://localhost:8180/api/cottage-terms/reservation').then(resp => {
    ...
    showIf: function(reservation){
        return this.showByCottageName(reservation) && this.showByReservationType(reservation) && this.showByClientName(reservation) && this.showByTime(reservation)
    },
    showByCottageName: function(reservation){
