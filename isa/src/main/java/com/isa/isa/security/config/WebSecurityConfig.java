...
import com.isa.isa.security.security.auth.RestAuthenticationEntryPoint;
import com.isa.isa.security.security.auth.TokenAuthenticationFilter;
import com.isa.isa.security.service.impl.CustomUserDetailsService;
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
								...
								.antMatchers("/api/adventure/byinstructor/**").permitAll()		// /api/foo
								.antMatchers("/resources/**").permitAll()		// /api/foo
